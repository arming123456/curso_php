            ...
            <div class="form-group">
                <div class="col-lg-10">
                    <div class="input-group">
                        <input type="text" class="global_filter form-control" id="global_filter" placeholder="Ingrese dato a Buscar">
                            <span class="input-group-addon"><i class="fa fa-search"></i></span>
                    </div>
                </div>
                <div class="col-lg-2"> 
                <button class="btn btn-primary" onclick="AbrilModalRegistro()" style="width:100%"><i class="glyphicon glyphicon-plus"></i>Nuevo Registro</button>
                </div>
            </div>
...
<!--  inicio  modal registro de usuario -->
<form autocomplete="false" onsubmit="return false">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" id="txt_email" placeholder="Ingrese correo electronico">
    ...
    <div class="modal fade" id="modal_editar" role="dialog">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-lg-12">
                        <input type="text" id="txtidusuario" hidden><br>
                        <label for="">Usuario</label>
                        <input type="text" class="form-control" id="txtusu_editar" placeholder="Ingrese usuario" disabled><br>
                    </div>
                    <div class="col-lg-12">
                        <label for="">Correo</label>
                        <input type="text" class="form-control" id="txt_email_editar" placeholder="Ingrese correo electronico">
...
$(document).ready(function() {
    ...
    listar_combo_rol();
    $("#modal_registro").on('shown.bs.modal', function(){  // esto ==> $("#modal_registro").on('shown.bs.modal', function(){
        $("#txt_usu").focus();                              // y esto ==> $("#txt_usu").focus(); es para el focus en input usuario
     })
} );
...
$('.box').boxWidget({
    ...
    removeTrigger   :   '[data-widget="remve"]', 
